...
describe_v1 <-function(dataframe,variable) {
  ...
  summarise(
    ...
    q01   = format(quantile({{variable}},c(0.01) ),big.mark = ","),
    #q02   = quantile({{variable}},c(0.02) ),
    q03   = format(quantile({{variable}},c(0.03) ),big.mark = ","),  
    q05   = format(quantile({{variable}},c(0.05) ),big.mark = ","),
    q10   = format(quantile({{variable}},c(0.10) ),big.mark = ","),
    mean  = format(round(mean({{variable}}, na.rm=T), digits = 1),big.mark = ","),  
    median  = format(round(median({{variable}}, na.rm=T), digits = 1),big.mark = ","),  
    
    q90   = format(quantile({{variable}},c(0.90) ),big.mark = ","), 
    q95   = format(quantile({{variable}},c(0.95) ),big.mark = ","), 

    q97   = format(quantile({{variable}},c(0.97) ),big.mark = ","),
    #q98   = quantile({{variable}},c(0.98) ),
    q99   = format(quantile({{variable}},c(0.99) ),big.mark = ","),  
